            ...
            .each(function () {
                ...
                var defaults = {
                    ...
                    selector: {
						x 					: 0,
						y 					: 0,
						w 					: max_width_cropzoom,//max height
						h 					: max_height_cropzoom,//min height
						aspectRatio 		: false,
						centered 			: false,
						borderColor 		: 'yellow',
						...
						maxHeight 			: max_height_cropzoom,
						maxWidth 			: max_width_cropzoom,
...
$(document).on('click','.delete-image',function(){
    $('.browse-image img').attr("src","");
    $('.browse-image [name="img"]').val("");
});