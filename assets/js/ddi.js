$(document).ready(function(){
    ...
    $('.datepicker_custom_max_today').datepicker({
    	format : 'dd-mm-yyyy' ,
    	ignoreReadonly : true,
	    language: 'id',
	    endDate: new Date()
    ...
    $('.datepicker_custom_min_today').datepicker({
    	format : 'dd-mm-yyyy' ,
    	ignoreReadonly : true,
	    language: 'id',
    	startDate: new Date()
    });
    $(".datepicker_custom_min_today").datepicker("setDate", new Date());



    $('.datepicker_range_start, .datepicker_range_end').datepicker({
    	format : 'dd-mm-yyyy' ,
    	ignoreReadonly : true,
	    language: 'id',
	    endDate: new Date()
     ...
     $(".datepicker_range_start").on('changeDate', function(selected) {
        var startDate = new Date(selected.date.valueOf());
        $(".datepicker_range_end").datepicker('setStartDate', startDate);
        if($(".datepicker_range_start").val() > $(".datepicker_range_end").val()){
          $(".datepicker_range_end").val($(".datepicker_range_start").val());
        }
    });
...
function export_to_excel(type){
	if(type == 1) {
		...
		if($('#export_to_excel_form').parsley().validate()){
